...
import 'package:pr_ipo2/pestanas/ruta_detalles.dart';


class ItemRutas extends StatelessWidget {

  final Ruta _ruta;

  ItemRutas(this._ruta);
      ...
      new ListTile(
        ...
        onTap: () {
          ...
          Route ruta = new MaterialPageRoute(
              builder: (context) => new DetallesRuta(ruta: _ruta));
